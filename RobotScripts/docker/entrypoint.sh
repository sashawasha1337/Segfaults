#sets up ROS2 environement inside the docker container
#!/bin/bash
...
# The ROS_DOMAIN_ID will need to be the same for computers that you want to communicate w$
# This value can take any number between [0,232]. It is useful if you have multiple robot$
