...
class SuperSimpleEventNode(Node):
    def __init__(self):
        ...
        self._img_sub = self.create_subscription(CompressedImage, IMAGE_TOPIC, self._on_image, 10)
    ...
    def _on_image(self, msg: CompressedImage):
        ...
        if msg.format and "jpeg" not in msg.format.lower():
            self.get_logger().warning(f"Received CompressedImage with unexpected format '{msg.format}'")
